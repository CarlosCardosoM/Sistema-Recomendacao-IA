...
def enviar_email_verificacao(email_destino: str, token: str, nome: str):
    ...
    mensagem["Subject"] = "Seu código de acesso — Vetria"
...
Seu código de acesso ao Vetria é:
...
Vetria — Chatboot Educacional
    ...
    <html>
      <body style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #4A90D9;">Vetria — Chatboot Educacional</h2>
